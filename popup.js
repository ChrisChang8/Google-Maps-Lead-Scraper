document.addEventListener('DOMContentLoaded', function() {
    chrome.tabs.query({active: true, currentWindow: true}, function(tabs) {
        ...
        // Displays HTML
        // If current tab is google maps, enable search function
        if (currentTab && currentTab.url.includes("://www.google.com/maps/search") || currentTab.url.includes("https://www.google.com/maps/@")) {
            document.getElementById('message').textContent = "Let's scrape Google Maps!";
            actionButton.disabled = false;
            actionButton.classList.add('enabled');
        } else {
        // Else, display link for google maps
